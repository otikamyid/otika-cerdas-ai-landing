...
const Footer = () => <footer className="v3-footer text-white">
  <div className="container mx-auto px-4 py-14 sm:px-6 lg:px-8">
    ...
    <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <div><h2 className="text-base font-semibold">Fitur</h2><ul className="mt-4 space-y-3 text-sm text-slate-400"><li><a href="/fitur/whatsapp-api">WhatsApp API</a></li><li><a href="/fitur/whatsapp-coexistence">WhatsApp Coexistence</a></li><li><a href="/fitur/ai-agent">AI Agent</a></li><li><a href="/fitur/follow-up-ai">Follow Up by AI</a></li><li><a href="/fitur/broadcast-whatsapp">Broadcast</a></li><li><a href="/fitur/meta-capi">Meta Conversions API</a></li><li><a href="/kalkulator-biaya-whatsapp">Kalkulator Biaya WhatsApp</a></li></ul></div>
